<template>
  <div class="page-container">
                ...
                <div class="form-group">
                  ...
                  <div class="perms-list">
                    ...
                    >
                      ...
                      />
                      <span>{{ perm.displayNameAr || perm.name }}</span>
                      <small
                        class="text-muted"
                        style="
                          font-size: 0.7em;
    ...
    <ConfirmDialog
      v-model="showConfirm"
      title="حذف الدور"
      :message="`هل تريد حذف دور '${deleteTarget?.displayNameAr || deleteTarget?.name}'؟`"
      confirm-text="حذف"
      :loading="deleting"
      @confirm="doDelete"
    />
...
const confirmDelete = (role: Role) => {
  deleteTarget.value = role; // الآن سيتم تخزين الدور هنا بشكل صحيح
...
const doDelete = async () => {
  ...
  try {
    ...
    deleteTarget.value = null; // تنظيف الهدف بعد الحذف
  } catch (e: any) {
    toast.error(e.message);
  } finally {
